...
class BaseListPollsViewController: GarlandViewController {
    ...
    override func viewDidLoad() {
        ...
        nextViewController = { _ in
            return BaseListPollsViewController()
        }
        setupHeader(header)
    }
}

extension BaseListPollsViewController: UICollectionViewDataSource, UICollectionViewDelegate {
